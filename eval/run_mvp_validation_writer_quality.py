"""Run the writer-quality MVP validation campaign.
...
BASELINE_JSONL = ROOT / "eval" / "mvp_validation_20260708_recipient.jsonl"
OUT_JSONL = ROOT / "eval" / "mvp_validation_20260708_writer_quality.jsonl"
OUT_MD = ROOT / "eval" / "mvp_validation_20260708_writer_quality.md"
CAMPAIGN_ID = "mvp_validation_20260708_writer_quality"
...
def _write_report(rows: list[dict], summary: dict) -> None:
    ...
    lines = [
        "# MVP Validation - Writer Quality Fix",
        "",
